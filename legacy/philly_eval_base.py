...
#@profile
def run_policy(env, get_probs, get_out, nums, iters, score_type, plot_figure):
    rl_r = []
    f1_r = [] 
    f2_r = []
    sjf_r = []
    ...
    for iter_num in range(0, iters):
        ...
        schedule_algos = [env.fcfs_score, env.lcfs_score, env.smallest_score, env.largest_score, env.sjf_score, env.lpf_score, env.saf_score,
                env.laf_score, env.sexp_score, env.lexp_score, env.srf_score, env.lrf_score, env.multifactor_score, env.f1_score, env.wfp_score, env.uni_score, env.qssf_score]
        ...
        #print("schedule log values:",schedule_logs.values())
    ...
    print("printing all score of base scheduling policy:", sjf_r)
    print("Mean RL:", mean(rl_r))
    print("printing all score of RL scheduling policy:", rl_r)
    ...
    xticklabels = ['Base_policy', 'RL_policy']
...
if __name__ == '__main__':
    ...
    parser.add_argument('--rlmodel', type=str, default="data/logs/ppo2_150/ppo2_150_s0")
    ...
    parser.add_argument('--plot_figure', type=str, default="Figures/new_exp/philly/base/test.png")
    ...
    start = time.time()
    run_policy(env, get_probs, get_value, args.len, args.iter, args.job_score_type, args.plot_figure)
