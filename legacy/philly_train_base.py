...
def ppo(workload_file, model_path, ac_kwargs=dict(), seed=0,
    ...
    for epoch in range(epochs):
        ...
        while True:
            ...
            #print("inside epoch loop printing output of sess.run a=",a, end=" ")
            num_total += 1
            ...
            if buf.ptr - buf.path_start_idx>=10*JOB_SEQUENCE_SIZE or buf.ptr>=buf.max_size:
                ...
                print("checking if buf.ptr condition satisfy and reset is called again")
                [o, co], r, d, ep_ret, ep_len, show_ret, sjf, f1, skip_count = env.reset(), 0, False, 0, 0, 0, 0, 0, 0
                continue
            '''
        ...
        #print("Printing env.base_score_list_normalized=", env.base_score_list_normalized)
        #print("Printing env.rl_score_normalized=", env.rl_score_normalized)
        #print("prnting self.makespan_base=",env.makespan_base)
        #print("prnting self.makespan_rl=",env.makespan_rl)
        #print("prnting self.rewards=",env.rewards)

        with open('/home/shruti/SchedInsp_new/data/logs/new_exp/philly/pro/test.txt', 'a') as f:
          f.write(f'Epoch {epoch}: base_scores = {env.base_score_list_normalized}, rl_scores= {env.rl_score_normalized}, Makespan_base = {env.makespan_base}, Makespan_rl = {env.makespan_rl}, Rewards = {env.rewards}\n')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--trajs', type=int, default=50)
    parser.add_argument('--epochs', type=int, default=1)
    parser.add_argument('--exp_name', type=str, default='testttt')
    ...
    log_data_dir = os.path.join(current_dir, './data/logs/new_exp/qssf/pro/')
