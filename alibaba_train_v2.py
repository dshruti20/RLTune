"""
Train Alibaba v2: same as Helios v2 (base + RL pipelines, tier1+lex allocation, optional MILP for RL).
Uses alibaba_env_base_v2 (AlibabaEnvSkip, 5 GPU-type pools, tier1/tier2 per pool same as Helios).
"""
import numpy as np
...
from alibaba_env_base_v2 import AlibabaEnvSkip
...
def ppo(workload_file, model_path, ac_kwargs=dict(), seed=0,
        ...
        cluster_name='alibaba', use_milp_allocation=False):
    ...
    env = AlibabaEnvSkip(shuffle=shuffle, backfil=backfil, skip=skip, job_score_type=score_type,
    ...
    data_dir = logger_kwargs.get('data_dir', './data/logs/alibaba_v2')
...
if __name__ == '__main__':
    import argparse
    parser = argparse.ArgumentParser(description='Train Alibaba v2: base + RL pipelines, tier1+lex allocation')
    parser.add_argument('--workload', type=str, default='GPU_Traces/Alibaba_Formatted_withGPUType.csv')
    parser.add_argument('--model', type=str, default='./data/lublin_256.schd')
    parser.add_argument('--cluster', type=str, default='alibaba', choices=['alibaba'])
    parser.add_argument('--gamma', type=float, default=1)
    parser.add_argument('--seed', '-s', type=int, default=0)
    parser.add_argument('--cpu', type=int, default=1)
    parser.add_argument('--trajs', type=int, default=100)
    parser.add_argument('--epochs', type=int, default=1)
    parser.add_argument('--exp_name', type=str, default='alibaba_v2')
    parser.add_argument('--pre_trained', type=int, default=0)
    parser.add_argument('--trained_model', type=str, default='./data/logs/alibaba_v2/alibaba_v2_s0')
    ...
    log_data_dir = os.path.join(current_dir, 'data', 'logs', 'alibaba_v2')
