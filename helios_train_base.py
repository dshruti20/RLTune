...
def ppo(workload_file, model_path, ac_kwargs=dict(), seed=0,
    ...
    for epoch in range(epochs):
        ...
        with open('/home/shruti/SchedInsp_new/data/logs/new_exp/helios/base/output_FCFS_Uti.txt', 'a') as f:
...
if __name__ == '__main__':
    ...
    log_data_dir = os.path.join(current_dir, './data/logs/new_exp/helios/base/')
