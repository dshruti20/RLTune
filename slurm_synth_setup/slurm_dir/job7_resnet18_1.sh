#!/bin/bash
#SBATCH --job-name=job7_resnet18_1
#SBATCH --output=job7_resnet18_1.out
#SBATCH --gres=gpu:1
#SBATCH --ntasks=1
...
python Training_LogCollection.py --arch resnet18 --epochs 2 --batch-size 128 --dataset cifar100
