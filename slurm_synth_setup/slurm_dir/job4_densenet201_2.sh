#!/bin/bash
#SBATCH --job-name=job4_densenet201_2
#SBATCH --output=job4_densenet201_2.out
#SBATCH --gres=gpu:2
#SBATCH --ntasks=2
...
torchrun --nproc_per_node=2 Training_LogCollection.py --arch densenet201 --num-gpus=2 --mode ddp --epochs 2 --batch-size 32
