#!/bin/bash
#SBATCH --job-name=job11_resnet152_2
#SBATCH --output=job11_resnet152_2.out
#SBATCH --gres=gpu:2
#SBATCH --ntasks=1
...
python Training_LogCollection.py --arch resnet152 --num-gpus=2 --mode dp --epochs 1 --batch-size 32
