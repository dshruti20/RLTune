#!/bin/bash
#SBATCH --job-name=job5_bigscience_bloom-3b_4
#SBATCH --output=job5_bigscience_bloom-3b_4.out
#SBATCH --gres=gpu:4
#SBATCH --ntasks=1
...
deepspeed inference-test.py --name bigscience/bloom-3b --batch_size 8
