#!/bin/bash
#SBATCH --job-name=job13_densenet121_2
#SBATCH --output=job13_densenet121_2.out
#SBATCH --gres=gpu:2
#SBATCH --ntasks=1
...
python Training_LogCollection.py --arch densenet121 --num-gpus=2 --mode dp --epochs 1 --batch-size 64
