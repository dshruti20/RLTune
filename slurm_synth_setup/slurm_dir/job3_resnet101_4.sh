#!/bin/bash
#SBATCH --job-name=job3_resnet101_4
#SBATCH --output=job3_resnet101_4.out
#SBATCH --gres=gpu:4
#SBATCH --ntasks=1
...
python Training_LogCollection.py --arch resnet101 --num-gpus=4 --mode dp --epochs 2 --batch-size 32
